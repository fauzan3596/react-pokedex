    ...
    <section className="container-fluid text-black pb-5">
      <div className="container d-flex flex-column gap-3 pt-4">
        ...
        <p className="lead">
          ...
          up-to-date Pokedex on the market. Whether you're a beginner or a
          seasoned Pokémon Trainer, PokéVerse is here to make your Pokémon
          journey easier and more enjoyable.
        </p>
        <h3>Key Features & Advantages of Pokeverse</h3>
        <ul className="key-features">
          <li>Complete and Up-to-Date Pokedex</li>
          <li>
            Pokeverse offers an extensive Pokedex with detailed profiles of
        ...
        <ul className="key-features">
          ...
          <li>
            ...
            or a pro, Pokeverse offers a seamless experience. With simple
        ...
        <ul className="key-features">
          ...
          <li>
            Finding the perfect Pokémon has never been easier. Pokeverse
        ...
        <ul className="key-features">
          ...
          <li>
            Don't let your internet connection slow you down. Pokeverse allows
            you to access the Pokedex offline, making it a great companion even
            when you're on the go or in areas with limited connectivity. Your
            Pokedex is always with you, no matter where you are.
          </li>
        </ul>
        <ul className="key-features">
        ...
        <ul className="key-features">
          ...
          <li>
            The Pokémon universe is always expanding, and so is Pokeverse. The
            ...
            existing Pokémon, Pokeverse stays current.
          </li>
        </ul>
            ...
            <div class="card rounded-5">
              ...
              <div class="card-body">
                ...
                <p class="card-text">
                  ...
                  that Pokeverse is visually appealing and intuitive to use. His
            ...
            <div class="card rounded-5">
              ...
              <div class="card-body">
                ...
                <p class="card-text">
                  ...
                  knowledge of the Pokémon world ensures that Pokeverse remains
            ...
            <div class="card rounded-5">
              ...
              <div class="card-body">
                ...
                <p class="card-text">
                  ...
                  that Pokeverse runs smoothly on all devices. With his
        ...
        <h3>Pokeverse is more than just a Pokedex</h3>
        <p>
          it's your ultimate Pokémon guide. With its comprehensive database,
          user-friendly design, and constant updates, Pokeverse is the perfect
          tool for any Pokémon Trainer. Whether you're aiming to complete your
          Pokedex or learn more about your favorite Pokémon, Pokeverse is here
          to help.
        </p>
        <p className="lead">
